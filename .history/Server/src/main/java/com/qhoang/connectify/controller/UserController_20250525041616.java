...
public class UserController {
        ...
        try {
            ...
            if (!type.equals("user") && !type.equals("admin")) {
                return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                        .body(Collections.singletonMap("error", "Type phải là 'user' hoặc 'admin'"));
            }
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(Collections.singletonMap("error", "Lỗi khi tạo người dùng: " + e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> updateUser(@RequestHeader("Authorization") String authHeader,
        ...
        try {
            ...
            if (existingUser == null) {
                return ResponseEntity.status(HttpStatus.NOT_FOUND)
                        .body(Collections.singletonMap("error", "Không tìm thấy người dùng với ID: " + userId));
            }
            ...
            if (fullname != null) {
                ...
                // Cập nhật username dựa trên fullname mới
                String[] parts = fullname.trim().toLowerCase().split("\\s+");
                String lastName = parts[parts.length - 1];
                char firstInitial = parts[0].charAt(0);
                existingUser.setUsername(lastName + firstInitial);
            }
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(Collections.singletonMap("error", "Lỗi khi cập nhật người dùng: " + e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> deleteUser(@RequestHeader("Authorization") String authHeader,
        ...
        try {
            ...
            String token = authHeader.replace("Bearer ", "");
            String currentUserId = jwtUtil.extractUsername(token);
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(Collections.singletonMap("error", "Lỗi khi xóa người dùng: " + e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> getUserById(@RequestHeader("Authorization") String authHeader,
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(Collections.singletonMap("error", "Lỗi khi lấy thông tin người dùng: " + e.getMessage()));
        }
    }
}
