...
/**
 * Format image URL for products
 * @param {string} imageName - Image file name (e.g., "1_apple_123abc.jpg")
...
export const formatImageUrl = (imageName) => {
  ...
  // If imageName starts with /, it's already a path
  if (imageName.startsWith('/')) {
    return `${baseUrl}${imageName}`;
  }

  // API returns just filename, so add /images/ prefix
